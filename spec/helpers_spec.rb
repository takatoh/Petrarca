...
include ISBNUtils::Helpers

RSpec.describe ISBNUtils::Helpers do
  ...
  describe "split_to_parts" do
    it "returns a Array include prefix and body" do
      expect(split_to_parts(isbn13.sub(/^978/, ""), ISBNUtils::REGISTRATION_GROUP_RANGES["978"])).to eq ["4", "815606442"]
    end
  end
